function thirdAnimation() {
  ...
  (function() {
    (function(lib, img, cjs, ss, an) {
      ...
      lib.ssMetadata = [
        {name:'test2_4_to_check_atlas_', frames: [[1910,0,1908,1008],[0,1010,1908,1008],[0,0,1908,1008],[0,2020,1908,1008],[1910,1010,1908,1008],[1910,2020,1908,1008]]}
      ];
      ...
      (lib.futuranima_2 = function() {
        this.spriteSheet = ss['test2_4_to_check_atlas_'];
        this.gotoAndStop(0);
      ...
      lib.properties = {
        ...
        webfonts: {},
        manifest: [
          {src:'/img/test2_4_to_check_atlas_.png', id:'test2_4_to_check_atlas_'}
        ],
        preloads: []
      };
